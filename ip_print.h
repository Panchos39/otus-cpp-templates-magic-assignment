...
namespace print_utils {
    /*!
    Шаблон функции, выводящий в поток ip адресс на основе строкого входа
    \param[in] ip Ip адресс, в формате ссылки на строку, где может быть любое содержимое
    ...
    */
    ...
    /*!
    Шаблон функции print_ip, выводящий в поток ip адресс на основе арифметического типа, где адрес представлен как единственное число
